...
def main():
    ...
    parser.add_argument('--video', default=r"D:\for_study\code_source\code\card\demo\zjr_toy.mp4", help='Video file or webcam id')
    ...
    parser.add_argument(
        '--output-file', default=r"D:\for_study\code_source\code\card\demo", type=str, help='Output video file path')
    parser.add_argument(
        '--output-fourcc',
        default='MJPG',
        type=str,
