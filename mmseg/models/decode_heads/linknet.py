...
class LinkNet(BaseDecodeHead):
    """
    Generate Model Architecture
    """

    def __init__(self, n_classes=21, **kwargs):
        """
        Model initialization
        :param x_n: number of input neurons
        :type x_n: int
        """
        super(LinkNet, self).__init__(**kwargs)

        base = timm.create_model(model_name='resnet18', pretrained=True)
