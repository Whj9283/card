...
class SwinUnet(BaseDecodeHead):
    def __init__(self, img_size=512, out_channel=21843, zero_head=False, vis=False, **kwargs):
        super(SwinUnet, self).__init__(**kwargs)
